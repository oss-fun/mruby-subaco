...
static int
vmmcall_set_whitelist (unsigned char *addr)
{
...
static mrb_value
mrb_subaco_getpid (mrb_state *mrb, mrb_value self)
{
...
static mrb_value
mrb_subaco_set_whitelist (mrb_state *mrb, mrb_value self)
{
